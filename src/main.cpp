...
const sf::Vector2f INITIAL_BIRD_POS = {100.f, 400.f};
const float INITIAL_BIRD_RAD = 15.0f;
...
struct BirdState {
    BirdState() : velocityY{INITIAL_BIRD_VELOCITY_Y}, bird{INITIAL_BIRD_RAD} {
        // ====== ====== ======
        // TODO: (Q1)
        ...
        // ====== ====== ======
            ...
            bird.setPosition(INITIAL_BIRD_POS);
